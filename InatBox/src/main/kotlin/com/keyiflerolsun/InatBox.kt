...
class InatBox : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "${contentUrl}/CDN/001/002/dizibox/nf/index.php" to "Netflix",
        "${contentUrl}/CDN/001/002/dizibox/dsny/index.php" to "Disney+",
        "${contentUrl}/CDN/001/002/dizibox/amz/index.php" to "Amazon Prime",
        "${contentUrl}/CDN/001/002/dizibox/hb/index.php" to "HBO Max",
        "${contentUrl}/CDN/001/002/dizibox/tbi/index.php" to "Tabii",
        //"${contentUrl}/film/mubi.php" to "Mubi",
        //"${contentUrl}/ccc/index.php" to "TOD",
        "${contentUrl}/CDN/001/002/dizibox/yabanci-dizi/index.php" to "Yabancı Diziler",
        "${contentUrl}/CDN/001/002/dizibox/yerli-dizi/index.php" to "Yerli Diziler",
